...
def run_sched(surveys, survey_length=365.25, nside=32, fileroot='baseline_', verbose=False,
              extra_info=None, cloud_limit=0.699):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--cloud_limit", type=float, default=0.699)
    ...
    run_sched(surveys, survey_length=survey_length, verbose=verbose,
              fileroot=os.path.join(outDir, 'weather_%.2fc_' % cloud_limit), extra_info=extra_info, cloud_limit=cloud_limit)
